<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li> <a href="../freelancerhomepage.php"> Home </a> </li>
                    ...
                    <li class="dropdown"> 
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="glyphicon glyphicon-user"> </i> <span class="caret"></span> </a> 
                                <ul class="dropdown-menu">
                                    ...
                                    <li> <a href="viewfreelancerprofile.php">Profile</a></li>
            ...
            <div class="collapse navbar-collapse navbar-sidebar-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="projects_dropdown" class="collapse">
                            <li> <a href="viewfreelancerprofile.php"> View Profile</a> </li>
                            <li> <a href="freelancereditprofile.php">Edit Profile</a> </li>
                        </ul>
                    </li>
