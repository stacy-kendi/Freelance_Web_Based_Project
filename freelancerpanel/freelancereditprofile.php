...
<?php 
    ...
    $ratePerHour = $_POST['user_rate_per_hour'];
    ...
    if (move_uploaded_file($_FILES['user_image']['tmp_name'], $target)) {
        ...
        $query .= "user_rate_per_hour = '{$ratePerHour}' ";
        ...
        header("Location: viewfreelancerprofile.php");
    }
?>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                    <label for="skills">Skills:</label>
                                        <input value="<?php if (isset($skills)) {echo $skills;}  ?>" type="text" class="form-control" name="skills" required>
                                </div>
                            ...
                            <div class="form-group">
                                    <label for="user_rate_per_hour">Rate Per Hour:</label>
                                        <input value="<?php if (isset($ratePerHour)) {echo $ratePerHour;}  ?>" type="text" class="form-control" name="user_rate_per_hour" required>
                                </div>
