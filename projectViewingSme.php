            ...
            ?>
                                ...
                                <div class='row'>
                                    <div class='col-sm-12'>
                                        ...
                                        <a href="singleprojectSME.php?p_id=<?php echo $project_id; ?>"> <?php echo  $project_title ?> </a>
                                        </br>
                                    </div>
                                </div> </br> </br>
                                ...
                                <div class='row'>
                                    <div class='col-sm-5'>
                                        ...
                                        <a href='attachmentUploads/<?php echo $project_attachment ?>' target='_blank'>Open File</a>
