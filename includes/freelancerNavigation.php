...
<div class="container">
    ...
    <div class="navbar-header">
        ...
        <a id="navbrand" href="freelancerhomepage.php" class="navbar-brand" alt="sitename"> Tujiajiri </a>
    </div>
...
<!--Main Navigation Links--> 
        ...
        <ul class="nav navbar-nav navbar-center"> 
            <li>  <a href="freelancerpanel/index2.php"> Dashboard </a>  </li>
            <li>  <a href="encryption/encryptionretriveprojectdetails.php"> Projects </a>  </li>
            <li> <a href="submitBid.php"> Bids </a> </li>
...
<!--User & Bell Navigation-->
        <ul class="nav navbar-nav pull-right"> 
            ...
            <li id="icons"> <a href="C:/Users/user/Documents/ElegantlyHandy%20website/home.html"> <i class="glyphicon glyphicon-bell"> </i> </a> </li> 
            ...
            <li class="dropdown" id="icons"> 
                <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="glyphicon glyphicon-user"> </i> <span class="caret"></span> </a> 
                     <ul class="dropdown-menu">
                        ...
                        <li> <a href="freelancerpanel/freelancerprofile.php">Profile</a></li>
                        <li> <a href="freelancerpanel/index2.php">Dashboard</a></li>
